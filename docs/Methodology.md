# Credit score model methodology

This file defines the modelling methodology used for developing the credit
score model that is the project's main deliverable.
